...
const AddItem = () => {
        ...
        fetch(img_hosting_url, {
            ...
            .then(imgResponse => {
                if (imgResponse.success) {
                    ...
                    const classItem = {  name, email, available_seat:parseInt(available_seat), instructor_name, price: parseFloat(price), image: imgURL }
    ...
    return (
        ...
        <h1 className='text-center font-bold text-3xl my-10'>Add Class Section</h1>
            ...
            <div className='bg-slate-200 rounded-3xl p-5'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input className="btn btn-warning my-4 w-full" type="submit" value="Add Item" />
                </form>
            </div>
